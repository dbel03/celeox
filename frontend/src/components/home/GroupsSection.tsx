const ExcursionGroups = [
  { id: 1, name: 'Los Exploradores del moco', location: 'Excursión al Montcau', members: 4 },
  { id: 2, name: 'Los cracks', location: 'Excursión a los pirineos', members: 3 },
  { id: 3, name: 'Guapiabuelas', location: 'Excursión a Vallparadis', members: 5 },
]
